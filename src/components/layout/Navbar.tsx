    ...
    <nav className="fixed top-0 w-full z-[100] bg-brand-beige/80 backdrop-blur-md border-b border-brand-gold/10">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-20 h-20 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <button className="hidden sm:block bg-brand-dark text-white px-8 py-3 text-[10px] tracking-widest font-bold hover:bg-brand-gold hover:text-brand-dark transition-all duration-500 border border-brand-dark">
            AGENDAR CONSULTA
          </button>
          
          {/* Menu Mobile Icon (SVG Nativo) */}
